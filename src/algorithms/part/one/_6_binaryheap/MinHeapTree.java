...
public class MinHeapTree<P extends Comparable<P>> implements BinaryHeapTree<P> {
    ...
    // to initialize the array based on the given List and convert it into a Min Heap Tree
    ...
    // to initialize the array based on the given array and convert it into a Min Heap Tree
    public MinHeapTree(P[] array) {
        this(Arrays.asList(array));
    }

    // function to swim an index from a heap position to it's upper positions if required
    // i.e. if it is greater than it's child it should be moved up recursively in the heap
    @Override
